...
var chart = c3.generate({
  ...
  var publicSpreadsheetUrl1 = 'https://docs.google.com/spreadsheets/d/1Z6U8Ek_19rly_i6sNxDFee5dl2Nn42Ys17JIUgfSnyI/pubhtml';
  ...
  function showInfo3(data3, tabletop3) {
    ...
    function loadArray(data){
       ...
       for (i = 0; i < data.length; i++) {
             //console.log(i)
           pos = i + 1;
content += '<tr><td class="nowrap">'+data[i].Date+'</td><td class="financial">£'+data[i].Levy+'</td><td class="financial">£'+data[i].Monthly+'</td><td class="financial">£'+data[i].Completion+'</td><td class="financial">£'+data[i].Expired+'</td><td class="numeric highlight">£'+data[i].CoInvestmentYou+'</td><td class="numeric highlight">£'+data[i].CoInvestmentGov+'</td><td class="financial">£'+data[i].Balance+'</td></tr>';
           renderTable(content);
            }
        }     
